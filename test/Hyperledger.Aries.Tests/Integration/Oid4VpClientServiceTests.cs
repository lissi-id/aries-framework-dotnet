...
namespace Hyperledger.Aries.Tests.Integration
{
    public class Oid4VpClientServiceTests : IAsyncLifetime
    {
        ...
        public async Task CanExecuteOpenId4VpFlow()
        {
            ...
            const string expectedRedirectUrl = "https://client.example.org/cb#response_code=091535f699ea575c7937fa5f0f454aee";
            ...
            var response = await _oid4VpClientService.PrepareAndSendAuthorizationResponse(_agent1.Context, new Uri(authorizationRequest.RedirectUri),
