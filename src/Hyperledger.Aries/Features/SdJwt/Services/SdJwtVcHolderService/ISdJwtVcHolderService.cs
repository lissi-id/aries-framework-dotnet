...
namespace Hyperledger.Aries.Features.SdJwt.Services.SdJwtVcHolderService
{
    ...
    public interface ISdJwtVcHolderService
    {
        ...
        /// </remarks>
        /// <param name="fieldNames">The claims to disclose</param>
        ...
        Task<string> CreatePresentation(SdJwtRecord credential, string[] fieldNames, string? audience = null, string? nonce = null);
